...
def register():
    ...
    if request.method == 'POST':
        ...
        hashed_password = generate_password_hash(password=password, method='pbkdf2', salt_length=16)
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if not current_user.is_authenticated:
            ...
            return redirect(url_for('login'))
        new_comment = Comment(text=request.form.get('comment'), parent_post=current_post, comment_author=current_user)
